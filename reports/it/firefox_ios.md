...
| **Locale tree** | `https://github.com/mozilla-l10n/firefoxios-l10n` @ `6b4ba8b908f8` |
| **en-US reference** | `https://github.com/mozilla-l10n/firefoxios-l10n` @ `6b4ba8b908f8` |
| **Previous run** | _none — this is the baseline_ @ `—` |
| **Mode** | baseline |
| **Strings reviewed this run** | 0 of 1,894 |
...
| apostrophe | `typographic` 69 | **typographic** |
