...
- `add_login_hostname_invalid_text_3` — `mozilla-mobile/fenix/app/src/main/res/values-pt-rBR/strings.xml` — Straight double quotes used instead of the locale's curly double quotes.
    ...
    - Source uses curly quotes and the pt-BR convention is curly-double quotes.
...
- `firstrun_shortcut_text` — `mozilla-mobile/focus-android/app/src/main/res/values-pt-rBR/strings.xml` — Straight double quotes used instead of the locale's curly double quotes.
    - Current: `"Adicionar à tela inicial"`
    - Source: `Return to your favorite sites in %1$s quickly. Just select “Add to Home screen” from the %1$s menu.`
    - Suggest: `“Adicionar à tela inicial”`
    - The source uses curly quotes (“Add to Home screen”) and the pt-BR convention is curly-double quotes.
...
- `add_login_hostname_invalid_text_3` — `mozilla-mobile/fenix/app/src/main/res/values-pt-rBR/strings.xml` — fixed 2026-08-21
- `preference_summary_delete_browsing_data_on_quit_2` — `mozilla-mobile/fenix/app/src/main/res/values-pt-rBR/strings.xml` — fixed 2026-08-21
- `firstrun_shortcut_text` — `mozilla-mobile/focus-android/app/src/main/res/values-pt-rBR/strings.xml` — fixed 2026-08-21
- `firstrun_shortcut_text` — `mozilla-mobile/focus-android/app/src/main/res/values-pt-rBR/strings.xml` — fixed 2026-08-21
