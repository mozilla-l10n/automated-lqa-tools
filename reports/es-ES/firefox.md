...
Also for es-ES: [android](android.md)
...
### 🔁 String changed, defect not verifiable — needs a re-read (72)
...
**989 strings** are not translated yet, concentrated in:

- `browser/browser/newtab/newtab.ftl` — 142
