...
| **Mode** | baseline |
| **Strings reviewed this run** | 2,592 of 2,592 |
...
| 2 | Wrong content (says something other than the English) | 94 |
...
- `never_translate_site_header_preference` — `mozilla-mobile/fenix/app/src/main/res/values-in/strings.xml` — fixed 2026-08-21
- `firstrun_shortcut_text` — `mozilla-mobile/focus-android/app/src/main/res/values-in/strings.xml` — fixed 2026-08-21
